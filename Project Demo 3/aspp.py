...
#         self.conv2 = nn.Conv2d(in_channels, out_channels, kernel_size=3, stride=1, padding=self.atrous_rates[0], dilation=self.atrous_rates[0], bias=False)
#         self.bn2 = nn.BatchNorm2d(out_channels)
#         self.conv3 = nn.Conv2d(in_channels, out_channels, kernel_size=3, stride=1, padding=self.atrous_rates[1], dilation=self.atrous_rates[1], bias=False)
#         self.bn3 = nn.BatchNorm2d(out_channels)
#         self.conv4 = nn.Conv2d(in_channels, out_channels, kernel_size=3, stride=1, padding=self.atrous_rates[2], dilation=self.atrous_rates[2], bias=False)
#         self.bn4 = nn.BatchNorm2d(out_channels)
        
#         self.global_avg_pool = nn.AdaptiveAvgPool2d((1, 1))
#         self.conv_pool = nn.Conv2d(in_channels, out_channels, kernel_size=1, stride=1, bias=False)
